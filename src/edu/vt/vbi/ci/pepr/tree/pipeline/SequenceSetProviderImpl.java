...
public class SequenceSetProviderImpl implements SequenceSetProvider {
	...
	public SequenceSetProviderImpl() {
	}
	 ...
	 *                not be loaded.
	 */
	public SequenceSetProviderImpl(String sequenceFileDir, int minTax) {
	...
	public SequenceSetProviderImpl(FastaSequenceSet[] sequenceSets) {
	 ...
	 *                not be loaded.
	 */
	public SequenceSetProviderImpl(String[] fileNames, int minTax) {
		try {
	 ...
	 *                not be loaded. 
	 */
	public SequenceSetProviderImpl(String[] fileNames, int minTax, int maxTax) {
		try {
			ArrayList sequenceSetList = new ArrayList(fileNames.length);
			sequenceFileNames = fileNames;
			for(int i = 0; i < fileNames.length; i++) {
